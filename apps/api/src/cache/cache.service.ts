...
export class CacheService implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit() {
    ...
    // this.cardSubscriber.subscribe('__keyspace@0__:*', (err) => {
    //   this.logger.log('Subscribed to keyspace notifications for all keys');
    //   if (err) {
    //     this.logger.error('Failed to subscribe to keyspace notifications:', err);
    //   }
    // });
